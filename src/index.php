...
try {
    ...
    pl('My account is now ' . ($bankAccount1->isOpen() ? 'open' : 'closed'));
...
} catch (ZeroAmountException|BankAccountException $e) {
    pl($e->getMessage());
}
...
try {
    ...
    try {
        ...
        pl('My new balance after withdrawal (-50): ' . $bankAccount2->getBalance());
    } catch (ZeroAmountException|BankAccountException|FailedTransactionException|InvalidOverdraftFundsException $e) {
        pl('Transaction failed: ' . $e->getMessage());
    }
    ...
    try {
        ...
        pl('My new balance after withdrawal (-120): ' . $bankAccount2->getBalance());
    } catch (ZeroAmountException|BankAccountException|FailedTransactionException|InvalidOverdraftFundsException $e) {
        pl('Transaction failed: ' . $e->getMessage());
    }
    ...
    try {
        ...
        pl('My new balance after withdrawal (-20): ' . $bankAccount2->getBalance());
    } catch (ZeroAmountException|BankAccountException|FailedTransactionException|InvalidOverdraftFundsException $e) {
        pl('Transaction failed: ' . $e->getMessage());
    }
